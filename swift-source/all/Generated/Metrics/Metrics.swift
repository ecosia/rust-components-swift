...
extension GleanMetrics {
    class GleanBuild {
        ...
        public static let info = BuildInfo(buildDate: DateComponents(calendar: Calendar.current, timeZone: TimeZone(abbreviation: "UTC"), year: 2024, month: 1, day: 11, hour: 18, minute: 59, second: 29))
    }
